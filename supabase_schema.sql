...
create policy "Users can manage own saved buildings"
  on public.saved_buildings for all
...
create table public.price_alerts (
  ...
  building_name text,
  area text,
  alert_type text default 'new_transaction', -- 'new_transaction' | 'price_drop'
  email text,
