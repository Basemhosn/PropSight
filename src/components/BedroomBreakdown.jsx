  ...
  return (
    <div style={{ background: "#0A1628", color: "#fff", borderRadius: 8, padding: "10px 14px", fontSize: 12, minWidth: 190 }}>
      ...
      <div style={{ color: "#8AAAC8" }}>
        Total value: <span style={{ color: "#fff" }}>{fmtAED(d.total, true)}</span>
      </div>
    </div>
  );
};
  ...
  return (
    <div style={{ background: "#fff", border: "1px solid #E8ECF2", borderRadius: 12, padding: "1.25rem" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between",
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 600, color: "#0A1628" }}>Bedroom type breakdown</div>
      ...
      <div style={{ marginBottom: "1rem", overflowX: "auto", whiteSpace: "nowrap", paddingBottom: 4 }}>
        {topAreas.map(a => (
          <button key={a} onClick={() => setSelectedArea(a)} style={{
            ...
            background: selectedArea === a ? "#0A1628" : "#fff",
            color: selectedArea === a ? "#fff" : "#7A8499",
            flexShrink: 0,
        ...
        {priceLadder.map((d, i) => {
          ...
          return (
            <div key={d.room} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 7 }}>
              ...
              <div style={{ width: 90, fontSize: 11, color: "#0A1628", fontWeight: 600, textAlign: "right" }}>
