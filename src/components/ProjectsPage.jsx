    ...
    <div style={{ padding:"1.25rem", maxWidth:1400, margin:"0 auto" }}>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:"1.5rem", flexWrap:"wrap" }}>
        <div style={{ flex:1, minWidth:200 }}>
          <div style={{ fontSize:20, fontWeight:700, color:"#0A1628" }}>Projects</div>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:8, background:"#fff",
          ...
          <input value={search} onChange={e=>setSearch(e.target.value)}
            ...
            style={{ border:"none", outline:"none", fontSize:13, color:"#0A1628", background:"transparent", width:"100%" }} />
        ...
        <select value={filterReg} onChange={e=>setFilterReg(e.target.value)}
          style={{ fontSize:12, padding:"7px 10px", borderRadius:8, border:"1px solid #E8ECF2", background:"#fff", color:"#0A1628" }}>
