    ...
    >
      <div style={{ height:160, overflow:"hidden", position:"relative", flexShrink:0 }}>
        ...
        <div style={{
          ...
          color:"#fff", fontSize:10, fontWeight:600, padding:"3px 8px", borderRadius:20,
        }}>
      ...
      <div style={{ padding:"0.875rem", flex:1 }}>
        <div style={{
          fontSize:13, fontWeight:600, color:"#0A1628", marginBottom:3, lineHeight:1.3,
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:6 }}>
          {[
            ["Transactions", fmtNum(kpis.count), "#0A1628"],
            ["Total value",  fmtAED(kpis.total,true), "#185FA5"],
            ["Avg deal",     fmtAED(kpis.avg,true), "#0A1628"],
            ["Price/m²",     kpis.ppsqm>0 ? fmtAED(kpis.ppsqm,true) : "—", "#1D9E75"],
